...
begin
    memoria(0 to 11) <= (
        ...
        "00100000000010010000000000101000",
        ...
        "10001101010010111111111111111100",
        "10001101010011001111111111111000",
        "00000001011011000110100000100000",
        "10101101010011010000000000000000",
...
-- fim:
    ...
    -- Ignora os dois bits menos significativos para converter bytes em palavras.
